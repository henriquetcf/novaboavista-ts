...
const page = () => {
    ...
    const [selected, setSelected] = React.useState("despachante");
    ...
    const signIn2 = (e: any, provider: LiteralUnion<string>): void => {
        e.preventDefault()
        const x = signIn(provider)
    ...
    return (
        <div className="bg-white p-6 shadow-default">
            <div className="grid h-screen grid-cols-2">
                <div className="grid h-screen p-40">
                    <div className="grid content-center sm:p-12.5 xl:p-17.5">
                    
                        <h2 className="mt-4 mb-12 text-3xl font-bold text-gray-400 text-center sm:text-title-xl2">
                            Nova Boa Vista
                        </h2>
                        ...
                        <div className="flex w-full flex-col">
                            ...
                            >
                                <Tab key="despachante" title="Despachante">
                                    <form className='relative px-4'>
                                        ...
                                        <div className='grid grid-cols-4 gap-4'>
                                            ...
                                            <div className='col-span-2'>
                                                <button onClick={(e) => signIn2(e, "google")} className="flex w-full items-center justify-center gap-3.5 rounded-lg border border-stroke bg-gray p-4 hover:bg-opacity-50">
                                                    <span>
                                                        <svg
                                                        width="20"
                                                        height="20"
                                ...
                                <Tab key="imobiliaria" title="Imobiliaria">
                                    <Card>
                                        <CardBody>
                                        EM CONSTRUÇÃO...
                                        </CardBody>
                ...
                <div className='xl:grid xl:content-center'>
                    <div className="hidden xl:w-full xl:block xl:w-1/2">
