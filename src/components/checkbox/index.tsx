  ...
  return (
    <input
      ...
      checked:border-none checked:text-white hover:cursor-pointer dark:border-white/10 ${
        color === "red"
          ? "checked:border-none checked:bg-rose-700 dark:checked:bg-gray-900"
          : color === "blue"
          ...
          : color === "gray"
          ? "checked:border-none checked:bg-gray-500 dark:checked:bg-gray-900"
          : "checked:bg-gray-500 dark:checked:bg-gray-900"
      } ${extra}`}
      name="weekly"
      {...rest}
    />
